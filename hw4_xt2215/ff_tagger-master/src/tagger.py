...
if __name__ == '__main__':
    ...
    # python src/tagger.py --train data/en.pos.train --train_data data/en.pos.train.data --model data/en.pos.train.model --vocab data/en.pos.train.vocab
    ...
    if options.test_file and options.model_path and options.vocab_path and options.output_file:
        ...
        writer = open(options.output_file, 'wb')
