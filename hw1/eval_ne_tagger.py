...
class Evaluator(object):
    ...
    def compare(self, gold_standard, prediction):
        ...
        for gs_word, gs_tag in gold_standard:  # Move through the gold standard stream
            ...
            pred_ends = curr_pred_type != None and ((pred_tag == None or pred_tag[0] in "OB") or (
                    curr_pred_type != pred_type and pred_tag[0] == "I"))
            gs_ends = curr_gs_type != None and (
                    (gs_tag == None or gs_tag[0] in "OB") or (curr_gs_type != gs_type and gs_tag[0] == "I"))
            ...
            if pred_word != None:
                pred_start = (pred_tag != None and pred_tag[0] == "B") or (
                        curr_pred_type == None and pred_tag[0] == "I") or \
